...
@section('content')
    <div x-data="{ defaultedpayment: false }" class="relative py-3 signup">
        <div class="top-desc mb-1">
            <div class="flex justify-between items-center mb-6">
                <h1 class="font-bold text-gray-800 text-2xl">Make Contribution</h1>
                ...
                if (element) {
                    ...
                    <span>Show Plan Info</span> <span :class="defaultedpayment ? 'mdi-close-circle-multiple' : 'mdi-plus'"
                        class="mdi"></span>
                </a>
            </div>
        </div>
        ...
        <div class="bg-gray-100 shadow-gray-300 shadow-lg mx-auto my-2 welcome-modal">
            ...
            <div class="mx-auto mt-3 px-5 md:px-7 py-5 rounded-lg investment-details-wrapper">
                <h3 class="text-md-bold text-2xl">You are about to make a contribution of <span
                        class="font-bold text-green-600 uppercase">N{{ $currentSubscription->sub_fee }}</span> for your
                    current subscription plan.</h3>
                {{-- <h5 class="mt-2 mb-5">Note: Each Plan Spans A Duration Of 52 Weeks</h5> --}}
                <br>

                <form class="d-flex flex-col gap-5 space-mobile" action="{{ route('dashboard.contribution.store') }}"
                    ...
                    <div class="form-inline align-items-center row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" value="{{ $currentSubscription->sub_fee }}" placeholder="Enter Amount"
                                readonly required class="form-control input" name="amount">
                        </div>
                    </div>
