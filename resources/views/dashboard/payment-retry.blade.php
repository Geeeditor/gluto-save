...
@section('description', 'Gluto HEP: Retry Checkout Plan')
@section('content')
    <div class="relative py-3 signup">
        <div class="top-desc mb-1">
            <h1 class="font-bold text-base md:text-3xl uppercase tracking-wide">Checkout Subscription Plan Repayment</h1>
        </div>
        ...
        <div class="bg-gray-100 shadow-gray-300 shadow-lg mx-auto my-2 welcome-modal">
            ...
            <div class="mx-auto mt-3 px-5 md:px-7 py-5 rounded-lg investment-details-wrapper">
                {{-- Subscription --}}
                <div>
                    <h3 class="text-md-bold text-2xl">You are about to pay for the <span
                            class="font-bold text-green-600 uppercase">Pro</span> Package </h3>
                    <h5 class="mt-2 mb-5">Note: Your Previous payment of N5,000.00 failed, If you got a reversal kindly
                ...
                {{-- Wallet Fund --}}
                <div>
                    <h3 class="text-md-bold text-2xl">You are about to fund your account with <span
                            class="font-bold text-green-600 uppercase">N10,000</span>. </h3>
                    <h5 class="mt-2 mb-5">Note: Your Previous payment of N10,000.00 failed, If you got a reversal kindly
                        proceed with making a new payment</h5>
                </div>
                ...
                <form class="d-flex flex-col gap-5 space-mobile" action="" method="POST"
                    enctype="multipart/form-data">
                    @php
                        $isDisabled = null;
                        // {{-- $isDisabled =
                        //     $userKYC->application_status === 'pending_approval' ||
                        //     $userKYC->application_status === 'approved'; --}}
                    @endphp
                    ...
                    <div class="form-inline align-items-center row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" readonly value="4000.00" required class="form-control input"
                                name="payment-amount">
                            {{-- {{ $isDisabled ? 'disabled' : '' }} --}}
                        </div>
                    </div>
                    ...
                    <select required class="hidden form-control select" id="payment_type" name="payment_type">
                        <option value="none">Select Payment Type</option>
                        <option value="wallet_fund">Wallet Fund</option>
                        <option value="subscription">Subscription</option>
                        <option value="contibution">Contribution</option>
                    </select>
                    ...
                    <div class="form-inline align-items-center row">
                        ...
                        <div class="col-sm-8" style="position:relative;">
                            <select required class="form-control select" id="payment_type" name="payment_method"
                    ...
                    <h6 align="left">
                        <span>
                            Note: Ensure to submit your document for verification before this subscription maturation.
                        </span>
                    </h6>

                    <div id="payment_upload_container"
                        class="hidden top-0 left-0 fixed justify-center shadow-lg blur-bg rounded-lg w-full h-[100vh] md:overflow-hidden overflow-y-scroll">
                        <div style="margin-top: 2%" class="bg-white mx-auto w-11/12 max-w-lg h-fit">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-gray-600 text-center"> If your payment slip is detected to be fake your
                                    account will be flagged and your package terminated.</p>
                                <div
                                    ...
                                    <label for="file" class="flex items-center cursor-pointer custum-file-upload">
                                        ...
                                        <div id="file-name" class="text">
                                            <span class="font-bold text-base md:text-2xl capitalize">Click to upload
                                                image</span>
                                        </div>
                                        <input id="file" type="file" name="payment_proof" class="hidden"
