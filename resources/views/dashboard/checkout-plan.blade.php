...
@section('description', 'Gluto HEP: Checkout Plan')
@section('content')
    <div class="relative py-3 signup">
        <div class="top-desc mb-1">
            <h1 class="font-bold text-base md:text-3xl uppercase tracking-wide">Checkout Subscription Plan</h1>
        </div>
        ...
        <div class="bg-gray-100 shadow-gray-300 shadow-lg mx-auto my-2 welcome-modal">
                ...
                <div class="mx-auto mt-3 px-5 md:px-7 py-5 rounded-lg investment-details-wrapper">
                        <h3 class="text-md-bold text-2xl">You are about to pay for the <span class="font-bold text-green-600 uppercase">{{$plan}}</span> Package </h3>
                    ...
                    <form class="d-flex flex-col gap-5 space-mobile" action="{{route('plan.checkout.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
