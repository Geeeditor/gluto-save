...
@section('description', 'Gluto HEP: Top Up Wallet')
@section('content')
    <div class="relative py-3 signup">
        <div class="top-desc mb-1">
            <h1 class="font-bold text-base md:text-3xl uppercase tracking-wide">Top Up Wallet</h1>
            <p>Fund your wallet with ease and convenience, you can use your wallet balance in paying for your weekly contributions or clearing defaulted weekly payments.</p>
        </div>
